      ...
      <div className="container flex items-center justify-between">
        <div className="flex items-center">
          ...
          <div className="hidden sm:flex space-x-1">
            ...
            <NavLinkButton to="/history" icon={<BarChartHorizontal size={18} />}>
              History
            </NavLinkButton>
        ...
        <div className="sm:hidden fixed bottom-0 left-0 right-0 bg-background border-t p-2 flex justify-between z-10">
          ...
          <NavLinkIcon to="/add-expense" icon={<PlusCircle size={20} />} label="Add" />
          <NavLinkIcon to="/history" icon={<BarChartHorizontal size={20} />} label="History" />
          <NavLinkIcon to="/goals" icon={<Target size={20} />} label="Goals" />
          <NavLinkIcon to="/profile" icon={<User size={20} />} label="Profile" />
        </div>
      </div>
    </nav>
  );
